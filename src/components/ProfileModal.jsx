...
const ProfileModal = ({ setShowEdit }) => {
    ...
    return (
        <div
            className='fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 no-scrollbar'
                            ...
                            <label htmlFor='profile_picture' className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <div className='group/profile relative'>
                                    <img src={editForm.profile_picture ? URL.createObjectURL(editForm.profile_picture) : user.profile_picture}
                                        alt="profile preview" className='w-24 h-24 rounded-full object-cover mt-2' />
